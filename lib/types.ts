...
export interface Sentence { id:number; sourceText:string; status:Status; error?:string|null; createdAt:string }
export interface Option { id:number; text:string; isCorrect:boolean }
export interface Block { id:number; position:number; correct:string; hint?:string|null; options:Option[] }
